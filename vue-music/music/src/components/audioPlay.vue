<template>
    <div class="main-page">
        ...
        <div class="background-flitter" :style="`background-image:url(${songInfo.cover})`">
        </div>
        <div class="play-mini">
            <div class="progress-bar" @click="handleProgressClick" ref="track">
                <div class="progress-box" :style="{width:audioProgressPersent}">
...
<script>
import Mscroll from '../base/lyricScroll'
  ...
  export default {
    ...
    data(){
        return {
          ...
          songList:[],
          volume:80,
          playType:1,//1.列表循环，2.随机 ，3.单曲循环
          showPlayType:'列表循环',
          audioProgress: 0,//当前 进度条进度
          thumbTranslateX: 0,//当前进度偏移长度px
          lyricIndex:0,
          color:"#fff",//文案默认颜色
          colorLight:"#40ce8f",//文案高两色
          fontSize:"16px",
          lineHeight:'42',
          paddingTop:"300px",//高粱文案部分居中
        }
    },
    created() {

      // let cursong=localStorage.getItem('cursong');
      // if(!cursong){
      //   this.getSong();
      // }
    },
